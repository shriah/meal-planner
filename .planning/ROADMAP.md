...
- [x] **Phase 6: Save, History, and Export** - Add calendar-week navigation, auto-save per week, and PNG export for sharing (completed 2026-03-22)
...
- [x] 06-03-PLAN.md — PNG export pipeline: satori + resvg-js route handler, export template, Export PNG button with Web Share API + download fallback
...
| 6. Save, History, and Export | 3/3 | Complete   | 2026-03-22 |
